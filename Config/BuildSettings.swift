...
final class BuildSettings: NSObject {
    ...
    // Vinix-Web instance for the app
    static let applicationWebAppUrlString = "https://staging.vinix.im/"


    // MARK: - Server configuration

    // Default servers proposed on the authentication screen
    static let serverConfigDefaultHomeserverUrlString = "https://vinix.im"
    static let serverConfigDefaultIdentityServerUrlString = "https://vinix.im"

    static let serverConfigSygnalAPIUrlString = "https://vinix.im/_matrix/push/v1/notify"


    // MARK: - Legal URLs
    static let applicationCopyrightUrlString = "https://www.vinixglobal.com/about"
    static let applicationPrivacyPolicyUrlString = "https://www.vinixglobal.com/hubfs/legal/Vinix-Privacy-Policy.pdf?hsLang=en"
    static let applicationTermsConditionsUrlString = "https://www.vinixglobal.com/hubfs/legal/Vinix-Privacy-Policy.pdf?hsLang=en"
    ...
    static let bugReportApplicationId = "Blast-ios"
    ...
    //Show or hide the Discovery message and options in the Settings view
    ...
    // MARK: - People Screen
    static let peopleScreenShowDiscoveryTerms: Bool = false
}
